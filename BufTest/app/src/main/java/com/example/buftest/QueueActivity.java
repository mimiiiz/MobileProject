...
//        String genKey = mDatabase.push().getKey();
//
//        Code tableCodeItem = new Code();
//        tableCodeItem.setCode("123");
//        tableCodeItem.setTableNo("mi11111");
//        tableCodeItem.setTimestamp("12:12:12");
//
//        mDatabase.child("Order").child(genKey).setValue(tableCodeItem);
//
//
//        Order oo = new Order();
//        oo.setAmount("5");
//        oo.setMenuName("5pork");
//        Order o2 = new Order();
//        o2.setAmount("6");
//        o2.setMenuName("7fish");
//        final ArrayList<Order> orderList = new ArrayList<Order>();
//        orderList.add(oo);
//        orderList.add(o2);
//        //loop to put order
//
//        Log.d("onClick", "new order !!!");
//        //[start-loop]
//        for (Order o: orderList){
////                  Log.d("onClick", "orderList Item: " + o.menuName + " " +  o.amount);
//            String orderItemId = mDatabase.push().getKey();
//            mDatabase.child("Order").child(genKey).child("menus").child(orderItemId).child("amount").setValue(o.getAmount());
//            mDatabase.child("Order").child(genKey).child("menus").child(orderItemId).child("menuName").setValue(o.getMenuName());
//        }
